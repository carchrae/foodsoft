...
* Article cards flow into two columns from 660px and three from 1100px, with
  the same stacked card layout as on phones (slightly more compact steppers in
  grid mode). The earlier desktop "row" layout is gone.
